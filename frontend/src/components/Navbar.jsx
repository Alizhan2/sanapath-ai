        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className="flex items-center gap-3 mr-2">
              <a href="https://github.com/Alizhan2" target="_blank" rel="noopener noreferrer" className="text-deep-blue-400 hover:text-neon-purple-400 transition-colors">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://twitter.com/sanapath_ai" target="_blank" rel="noopener noreferrer" className="text-deep-blue-400 hover:text-neon-purple-400 transition-colors">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://linkedin.com/company/sanapath-ai" target="_blank" rel="noopener noreferrer" className="text-deep-blue-400 hover:text-neon-purple-400 transition-colors">
